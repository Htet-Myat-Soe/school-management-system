<?php
    ...
    $all = $table->getAllProfessor($start,$limit);
...
<div class="container">
            <div class="row">
                <div class="col-12 d-flex justify-content-between">
                    <h2 class="text-bolder">Professors List <span class="badge badge-success"><?= count($table->countOfPro()   ) ?></span></h2>
                    <div class="btn-group">
                        <a href="#" class="add-new mx-2"><i class="fas fa-filter"></i></a>
                        <a href="../admin/create_professor.php" class="add-new mx-2"><i class="fas fa-plus"></i></a>
                ...
                <?php if(isset($_GET['created_fail'])): ?>
                    <div class="col-12 mt-4">
                        <div class="alert alert-danger">
                            Professor Create Fail , Try Again !
                ...
                <?php if(isset($_GET['updated_fail'])): ?>
                    <div class="col-12 mt-4">
                        <div class="alert alert-danger">
                            Professor Update Fail , Try Again !
                ...
                <?php if(isset($_GET['deleted_fail'])): ?>
                    <div class="col-12 mt-4">
                        <div class="alert alert-danger">
                            Professor Delete Fail , Try Again !
                ...
                <?php if(isset($_GET['photo_err'])): ?>
                    <div class="col-12 mt-4">
                        <div class="alert alert-danger">
                            Professor Photo have Error , Try Again !
                ...
                <?php if(isset($_GET['type_err'])): ?>
                    <div class="col-12 mt-4">
                        <div class="alert alert-danger">
                            Professor Type have error , Try Again !
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex py-5">
                                    <a href="../admin/professor_details.php?id=<?= $teacher->id ?>" class="btn-new mx-2"><i class="fas fa-info"></i></a>
                                    
                                    <a class="btn-new mx-2" href="../admin/update_professor.php?id=<?= $teacher->id ?>"><i class="text-primary fas fa-edit"></i></a>
            
                                    <a  onclick="alert('Are You Sure ?')" class="btn-new mx-2" href="../_actions/delete_professor.php?id=<?= $teacher->id ?>"><i class="text-primary fas fa-trash"></i></a>
                                </td>
                            </tr>
                ...
                <div class="col-12">
                    ...
                    <ul class="pagination mr-auto">
                        <li class="page-item"><a class="page-link bg-dark" href="../admin/professor.php?page=<?= $previous ?>">Previous</a></li>
                        <?php for($i = 1; $i <= $pages ;$i++): ?>
                        <li class="page-item"><a class="page-link bg-dark" href="../admin/professor.php?page=<?= $i ?>"><?= $i ?></a></li>
                        <?php endfor ?>
                        <li class="page-item"><a class="page-link bg-dark" href="../admin/professor.php?page=<?= $next ?>">Next</a></li>
                    </ul> 
                    
                    <p class="mr-3 text-dark text-bold mt-2"><?php echo $limit; ?> Rows Limit</p>
                    <form action="../admin/professor.php" method="post" >
