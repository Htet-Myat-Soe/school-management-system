...
<div class="container details shadow-lg mx-auto p-5 m-5">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            ...
            <a href="../admin/update_professor.php?id=<?= $details->id ?>" class="btn btn-success m-2">Edit</a>
            <a onclick="alert('Are You Sure ?')" href="../_actions/delete_professor.php?id=<?= $details->id ?>" class="btn btn-danger m-2">Delete</a>
        </div>
        <div class="col-md-6 col-sm-12 mt-5">
            <ul class="list-group">
                <li class="list-group-item"><b>Role  :</b> <?= $details->role ?></li>
